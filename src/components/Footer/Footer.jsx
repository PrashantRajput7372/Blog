        ...
        <div className="-m-6 flex flex-wrap">
          ...
          <div className="w-full p-6 md:w-1/2 lg:w-2/12">
            <div className="h-full">
              <h3 className="tracking-px mb-9  text-xs font-semibold uppercase text-gray-500 hover:underline">
                Company
              </h3>
              <ul>
                <li className="mb-4">
                ...
                <li className="mb-4">
                  <Link
                    className=" text-base font-medium text-gray-900  hover:underline hover:text-gray-700"
                    to="/"
                  >
                    Affiliate Program
                  </Link>
